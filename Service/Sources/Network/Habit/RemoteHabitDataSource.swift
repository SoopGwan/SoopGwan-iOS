...
public protocol RemoteHabitDataSource {
    ...
    func fetchAllHabit(date: String) -> AnyPublisher<[ArchiveHabitEntity], SoopGwanError>
    func updateStatus(req: UpdateStatusRequestDTO) -> AnyPublisher<Void, SoopGwanError>
